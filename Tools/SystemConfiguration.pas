...
type
  TfSystemConfiguration = class(TfBaseMaintenanceForm)
    vListsysconfig_code: TcxGridDBColumn;
    vListsysconfig_name: TcxGridDBColumn;
    vListsysconfig_description: TcxGridDBColumn;
    vListsysconfig_value: TcxGridDBColumn;
...
var
  fSystemConfiguration: TfSystemConfiguration;
...
procedure TfSystemConfiguration.vListFocusedRecordChanged(
  Sender: TcxCustomGridTableView; APrevFocusedRecord,
  AFocusedRecord: TcxCustomGridRecord; ANewItemRecordFocusingChanged: Boolean);
begin
  inherited;
  vListsysconfig_code.Options.Editing :=
