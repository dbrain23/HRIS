inherited fPayrollRegisterByDepartment: TfPayrollRegisterByDepartment
  Caption = 'fPayrollRegisterByDepartment'
  ClientHeight = 483
  ClientWidth = 976
  ExplicitWidth = 992
  ExplicitHeight = 522
  ...
  inherited pcMain: TJvPageControl
    ...
    inherited tsMain: TTabSheet
      Caption = 'Payroll register by department'
      ExplicitWidth = 968
      ExplicitHeight = 454
  ...
  object dstRegister: TADODataSet
    ...
    Filtered = True
    LockType = ltReadOnly
    CommandText = 'rpt_payroll_register_by_department;1'
