...
type
  TfDepartment = class(TfBaseMaintenanceForm)
    vListdepartment_code: TcxGridDBColumn;
    vListdepartment_name: TcxGridDBColumn;
    vListdepartment_description: TcxGridDBColumn;
  private
