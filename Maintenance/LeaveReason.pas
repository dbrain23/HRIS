...
type
  TfLeaveReason = class(TfBaseMaintenanceForm)
    vListleavereason_code: TcxGridDBColumn;
    vListleavereason_name: TcxGridDBColumn;
    vListleavereason_description: TcxGridDBColumn;
    vListleavetype_code: TcxGridDBColumn;
    vListis_active: TcxGridDBColumn;
  private
