...
type
  TfActivityStatus = class(TfBaseMaintenanceForm)
    vListactivitystatus_code: TcxGridDBColumn;
    vListactivitystatus_name: TcxGridDBColumn;
    vListactivitystatus_description: TcxGridDBColumn;
  private
...
var
  fActivityStatus: TfActivityStatus;
