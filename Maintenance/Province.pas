...
uses
  ...
  Vcl.StdCtrls, JvExStdCtrls, JvEdit, cxGraphics, cxControls, cxLookAndFeels,
...
type
  TfProvince = class(TfBaseMaintenanceForm)
    vListprovince_name: TcxGridDBColumn;
    vListabbreviation: TcxGridDBColumn;
  private
