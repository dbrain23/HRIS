...
type
  TfPositionStatus = class(TfBaseMaintenanceForm)
    vListposstatus_code: TcxGridDBColumn;
    vListposstatus_name: TcxGridDBColumn;
    vListposstatus_description: TcxGridDBColumn;
  private
...
var
  fPositionStatus: TfPositionStatus;
