...
type
  TfHolidayType = class(TfBaseMaintenanceForm)
    vListholidaytype_code: TcxGridDBColumn;
    vListholidaytype_name: TcxGridDBColumn;
    vListholidaytype_description: TcxGridDBColumn;
    vListholiday_rate: TcxGridDBColumn;
  private
