...
type
  TfAllowanceType = class(TfBaseMaintenanceForm)
    vListallowancetype_code: TcxGridDBColumn;
    vListallowancetype_name: TcxGridDBColumn;
    vListallowancetype_description: TcxGridDBColumn;
    vListis_voucher: TcxGridDBColumn;
  private
...
var
  fAllowanceType: TfAllowanceType;
