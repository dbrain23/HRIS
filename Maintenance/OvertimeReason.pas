...
type
  TfOvertimeReason = class(TfBaseMaintenanceForm)
    vListovertime_reason_code: TcxGridDBColumn;
    vListovertime_reason_name: TcxGridDBColumn;
    vListovertime_reason_description: TcxGridDBColumn;
  private
...
var
  fOvertimeReason: TfOvertimeReason;
