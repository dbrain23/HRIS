...
type
  TfLeaveType = class(TfBaseMaintenanceForm)
    vListleavetype_code: TcxGridDBColumn;
    vListleavetype_name: TcxGridDBColumn;
    vListleavetype_description: TcxGridDBColumn;
    vListmax_days: TcxGridDBColumn;
    vListinclude_weekends: TcxGridDBColumn;
  private
