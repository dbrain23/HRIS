...
uses
  ...
  cxGridCustomView, cxGrid, JvExControls, JvGroupHeader, Vcl.ExtCtrls,
  JvExExtCtrls, JvExtComponent, JvPanel, Vcl.ComCtrls, JvExComCtrls, JvComCtrls,
  cxTextEdit;

type
  TfAccountType = class(TfBaseMaintenanceForm)
    vListaccounttype_code: TcxGridDBColumn;
    vListaccounttype_name: TcxGridDBColumn;
    vListaccounttype_description: TcxGridDBColumn;
  private
