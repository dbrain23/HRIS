...
type
  TfEmpStatus = class(TfBaseMaintenanceForm)
    vListempstatus_code: TcxGridDBColumn;
    vListempstatus_name: TcxGridDBColumn;
    vListempstatus_description: TcxGridDBColumn;
  private
