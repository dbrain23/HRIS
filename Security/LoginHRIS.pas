...
uses
  ...
  cxGroupBox, BaseLoginForm;

type
  TfLoginHRIS = class(TfBaseLoginForm)
  private
...
var
  fLoginHRIS: TfLoginHRIS;

implementation

{$R *.dfm}

class function TfLoginHRIS.LoggedIn: boolean;
begin
  with TfLoginHRIS.Create(nil) do
  try
